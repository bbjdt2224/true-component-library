...
const TextButton = class {
  ...
  renderText() {
    const textBase = (index.h("true-text-base", { class: 'content', weight: this.weight, size: this.size }, index.h("slot", null)));
    if (this.location) {
      return (index.h("a", { href: this.location, target: this.newTab ? 'blank' : '' }, textBase));
    }
    else {
      return textBase;
    }
  ...
  render() {
    return (index.h(index.Host, { "aria-disabled": this.disabled ? 'true' : null, class: {
        'ion-activatable': true
      } }, index.h("button", { disabled: this.disabled, onClick: e => buttonCommon.removeButtonFocus(e), type: 'button', tabindex: this.focusable ? 0 : -1 }, index.h("slot", { name: 'start' }), this.renderText(), index.h("slot", { name: 'end' }))));
  }
  get host() { return index.getElement(this); }
};
TextButton.style = textButtonCss;

exports.true_text_button = TextButton;

//# sourceMappingURL=true-text-button.cjs.entry.js.map