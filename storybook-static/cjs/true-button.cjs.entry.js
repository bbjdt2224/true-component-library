...
const Button = class {
  ...
  render() {
    return (index.h(index.Host, { style: {
      ...
      }, "aria-disabled": this.disabled ? 'true' : null }, this.hasOverlay ? index.h("div", { class: 'overlay' }) : null, index.h("button", { disabled: this.disabled, onClick: e => buttonCommon.removeButtonFocus(e), type: this.submit === true ? 'submit' : 'button' }, index.h("true-text-base", { size: this.textSize, weight: 'medium' }, index.h("slot", null)), index.h("slot", { name: 'end' }))));
  }
  get element() { return index.getElement(this); }
};
Button.style = buttonCss;

exports.true_button = Button;

//# sourceMappingURL=true-button.cjs.entry.js.map