...
const TextBase = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { style: style, class: this.loaded ? 'loaded' : '' }, index.h("span", null, index.h("slot", null))));
  }
};
TextBase.style = textBaseCss;

exports.true_text_base = TextBase;

//# sourceMappingURL=true-text-base.cjs.entry.js.map