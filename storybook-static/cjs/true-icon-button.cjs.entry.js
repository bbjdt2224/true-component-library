...
const IconButton = class {
  ...
  renderBadge() {
    if (this.badge) {
      return (index.h("div", { class: "badge" }, index.h("true-subtext", { color: "neutral-100" }, this.badge)));
    }
  }
  render() {
    return (index.h(index.Host, { "aria-disabled": this.disabled ? 'true' : null, class: {
        'ion-activatable': true,
      } }, this.hasOverlay ? index.h("div", { class: "overlay" }) : null, index.h("button", { tabindex: this.tabindex, disabled: this.disabled, onClick: e => buttonCommon.removeButtonFocus(e) }, index.h("div", { class: "background" }), index.h("true-icon", { name: this.icon })), this.renderBadge()));
  }
};
IconButton.style = iconButtonCss;

exports.true_icon_button = IconButton;

//# sourceMappingURL=true-icon-button.cjs.entry.js.map